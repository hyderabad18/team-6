...
<div id="mySidenav" class="sidenav">
  ...
  <a href="http://localhost/pastevents.php"> Events Participated</a>
...
<div class="container">
  <h2> Event Registration</h2>
	<div class="form-group">
      ...
      <input type="text" class="form-control" id="event_name" placeholder="Enter Name" name="name">
    </div>
...
$sql = "INSERT INTO vol (name, location)
VALUES ('".$_POST["name"]."','".$_POST["location"]."')";
